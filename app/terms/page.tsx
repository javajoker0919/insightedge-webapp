const Terms = () => {
  return (
    <div className="flex flex-col items-center justify-start w-full min-h-screen overflow-y-auto">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              ProspectEdge reserves the right to set and enforce usage limits on
              the APIs, and the Customer agrees to comply with such limits.
            </p>
          </section>
        </div>
      </div>
