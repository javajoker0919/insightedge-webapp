      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          ...
          <g className="hidden lg:block">
            ...
            <rect x="100" y="600" width="40" height="40" fill="#3b82f6" opacity="0.2" transform="rotate(45 120 620)">
              <animateTransform attributeName="transform" type="rotate" 
                values="45 120 620; 90 120 620; 45 120 620" dur="6s" repeatCount="indefinite" />
            </rect>
          </g>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              <span className="text-[#004AAD]"> {/* Changed color to a brighter blue */}
                Compare our plans
              </span>
            </h2>
