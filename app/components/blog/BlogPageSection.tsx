...
const BlogSection: React.FC = () => {
  ...
  const [categoryBlogData, setCategoryBlogData] = useState<BlogPost[]>([]);
  ...
  const getBlogDataByCategory = async (categorySlug: string): Promise<void> => {
...
const BackgroundSVG: React.FC = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    >
      ...
      <path d="M0,100 Q250,50 500,100 T1000,100 V1000 H0 Z" fill="url(#grad2)">
        <animate
          attributeName="d"
      ...
      <g className="hidden lg:block">
        <polygon points="850,80 870,120 830,120" fill="#60a5fa" opacity="0.3">
          <animateTransform
...
const FeaturedBlogPost: React.FC<FeaturedBlogPostProps> = ({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="flex items-center h-64 md:h-full">
        <Image
...
const BlogPostGrid: React.FC<BlogPostGridProps> = ({ posts, onClick }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
    {posts.map((post) => (
      <div
        ...
        onClick={() => onClick(post.attributes.slug)}
      >
